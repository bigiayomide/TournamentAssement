...
describe('password-auth-strategy', () => {
  ...
  const successToken = hwbAuthCreateToken(HwbAuthSimpleToken, 'token', ownerStrategyName);
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        { provide: HwbPasswordAuthStrategy, useClass: HwbPasswordAuthStrategy },
      ],
    });
  });

  beforeEach(async(inject(
    [HwbPasswordAuthStrategy, HttpTestingController],
    (_strategy, _httpMock) => {
      strategy = _strategy;
      httpMock = _httpMock;
