...
@Component({
  selector: 'hwb-request-password-page',
...
export class HwbRequestPasswordComponent {
  ...
  requestPass(): void {
    ...
    this.service.requestPassword(this.strategy, this.user).subscribe((result: HwbAuthResult) => {
