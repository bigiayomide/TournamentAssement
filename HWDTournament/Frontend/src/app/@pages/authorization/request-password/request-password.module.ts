...
import { HwbRequestPasswordComponent } from './request-password.component';
import { 
        MatCardModule,
        MatButtonModule,
...
const routes: Routes = [
    {path: '', component: HwbRequestPasswordComponent},
  ];
@NgModule({
    imports: [
        MatCardModule,
...
export class HwbRequestPasswordModule {
}
