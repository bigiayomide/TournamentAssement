...
export class RegisterSComponent {
  ...
  registerUser(): void {
    ...
    this._registeruser.password = this.registerForm.get(
      "passwordForm.password"
    ).value;
    this._registeruser.confirmPassword = this.registerForm.get(
      "passwordForm.confirmpassword"
    ).value;

    this.dataService.register(this._registeruser).subscribe(
      (res: any) => {
      ...
      error => {
        ...
        this.showToast(
          "error",
          "Registration Failed",
          "Error occurred during registration process!" + error
        );
      }
    );
  }
