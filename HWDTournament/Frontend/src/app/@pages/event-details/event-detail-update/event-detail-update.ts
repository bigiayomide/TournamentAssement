...
import { IDialogMessage, IEventDetail, IResultVM, StatusEnum, IEvent, IEventDetailStatus } from '../../../shared/interfaces/interfaces';
  ...
  ngOnInit() {
    ...
    this.eventStatusDataService.GetAllEventStatus().subscribe((result) => {
      ...
      if (loginResult.status === StatusEnum.Success) {
        ...
        const exisitingvalue= this.eventstatuses.find(x=>x.id == viewdata.event_status_id);
