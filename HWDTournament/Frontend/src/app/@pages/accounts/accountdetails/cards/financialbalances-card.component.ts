...
import { IAccountFinancialBalanceVM } from '../../../../shared/interfaces/interfaces';
import { AccountDataService } from '../../../../shared/services/account.data.service';

@Component({
  selector: 'ngx-financialbalances-card',
  styleUrls: ['./financialbalances-card.component.scss'],
  templateUrl: './financialbalances-card.component.html',
...
export class FinancialBalancesCardComponent implements OnInit {
    ...
    financialbalance: IAccountFinancialBalanceVM;
     selectedAccountId: number;
     viewaccount: boolean = false;

     financialinfoLoaded: boolean = false;
   // approve: boolean= true;
    ...
    ngOnInit() {
        this.financialinfoLoaded = false;     
        this.loadFinancialInfo();
    }

    loadFinancialInfo() {  
        this.dataService.getAccountFinancialBalance(this.acc_code)
        .subscribe((financialbalance: IAccountFinancialBalanceVM) => {
            this.financialbalance = financialbalance;        
                     
               this.financialinfoLoaded = true;  
            },
            error => {                
