(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-Home-home-module-ngfactory~pages-event-details-event-detail-module-ngfactory"],{
...
/***/ "./src/app/shared/services/eventdetail.data.service.ts":
/*!*************************************************************!*\
  !*** ./src/app/shared/services/eventdetail.data.service.ts ***!
  \*************************************************************/
/*! exports provided: EventDetailDataService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EventDetailDataService", function() { return EventDetailDataService; });
...
var EventDetailDataService = /** @class */ (function () {
    function EventDetailDataService(http, configService) {
        this.http = http;
        this.configService = configService;
        this._baseUrl = "";
        this._baseUrl = configService.getApiURI();
    }
    EventDetailDataService.prototype.GetAllEventDetails = function () {
    ...
    EventDetailDataService.prototype.GetEventDetail = function (id) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]();
        headers.append("Content-Type", "application/json");
        return this.http
    ...
    EventDetailDataService.prototype.DeleteEventDetail = function (id) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]();
        headers.append("Content-Type", "application/json");
        return this.http
    ...
    EventDetailDataService.prototype.UpdateEventDetail = function (event) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]();
        headers.append("Content-Type", "application/json");
        return this.http
    ...
    EventDetailDataService.prototype.CreateEventDetail = function (event) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]();
        headers.append("Content-Type", "application/json");
        return this.http
...
//# sourceMappingURL=default~pages-Home-home-module-ngfactory~pages-event-details-event-detail-module-ngfactory.js.map